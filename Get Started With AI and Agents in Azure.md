...
<img src="././_resources/model-leaderboard.png">
...
<img src="././_resources/model-playground-example.png">
...
<img src="././_resources/save-create-agent.png">

<img src="././_resources/continue-testing-agent.png">
...
<img src="././_resources/agent-id.png">
<br/>
<br/>
...
<img src="././_resources/0-foundry-models.png">
...
<img src="././_resources/0-gpt-4.1-mini.png">
...
7.  Now to consume this model in the client application to do thta. In chat pane, view the code tab. This tab shows sample code that a client application can use to chat with the model.
    ...
    <img src="././_resources/0-chat-response.png">
...
11. Now to create an Agent from above model. In the model playground, at the top right select Save as agent. Then, when prompted, name your new agent expenses-agent.
    ...
    <img src="././_resources/0-agent-playground.png">
