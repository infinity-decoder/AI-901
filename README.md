...
| [Introduction to Natural Language Processing](Introduction%20to%20natural%20language.md) | Natural Language Processing fundamentals and concepts |
| [Introduction to Computer Vision Concepts](Introduction%20to%20computer%20vision%20concepts.md) | Core principles of computer vision and image processing |
| [Introduction to AI-Powered Information](Introduction%20to%20AI-powered%20information.md) | AI applications in information extraction and processing |
| [Get Started with AI in Azure - Foundry](Get%20started%20with%20AI%20in%20Azure-%20Foundary.md) | Azure AI platform introduction and services overview |
| [Get Started with AI and Agents in Azure](Get%20Started%20With%20AI%20and%20Agents%20in%20Azure.md) | Building intelligent agents using Azure AI services |
| [Get Started with Vision Azure](Get%20Started%20with%20Vision%20Azure.md) | Azure Computer Vision service capabilities and implementation |
| [Get Started with Text Analysis Azure](Get%20Started%20Text%20Analysis%20Azure.md) | Azure Text Analytics and Language services |
| [Get Started with Speech Analysis](Get%20Started%20with%20Speech%20Analysis.md) | Azure Speech and Voice services for audio processing |
| [Get Started with Information Extraction](Get%20Started%20With%20AI%20Information%20Extraction.md) | Information extraction techniques and Azure solutions |
| [AI-901 Quiz Sample](AI901%20quiz%20Sample.md) | Sample questions and practice quizzes for exam preparation |
| [Introduction to AI Speech](introduction-ai-speech.md) | Speech recognition and synthesis in AI applications |

## Key Topics Covered

- **Artificial Intelligence Fundamentals** - Core AI and ML concepts
- **Azure AI Services** - Overview of Azure AI platform and available services
- **Computer Vision** - Image analysis, object detection, and visual recognition
- **Natural Language Processing** - Text analysis, sentiment analysis, and language understanding
- **Speech Services** - Speech recognition, synthesis, and audio processing
- **Generative AI** - Modern generative models and their applications
- **Intelligent Agents** - Building and deploying intelligent agent systems
...
- Familiarity with Azure portal and services
- No prior AI/ML experience required

## External Resources

- [Microsoft Learn - Azure AI Fundamentals Path](https://learn.microsoft.com/en-us/training/paths/get-started-with-artificial-intelligence-on-azure/)
- [Azure AI Services Documentation](https://learn.microsoft.com/en-us/azure/ai-services/)
- [AI-901 Certification Details](https://learn.microsoft.com/en-us/credentials/certifications/azure-ai-fundamentals/)
...
├── 00 Practice_Guide.md               # Exam preparation guide
├── Introduction materials/            # Foundational concept guides
├── Get Started guides/                # Azure service implementation guides
├── AI-901 quiz Sample.md              # Practice exam questions
└── _resources/                        # Additional reference materials
```
...
- Practice hands-on labs in Azure environment
- Review difficult topics multiple times
- Take the quiz samples to identify weak areas
- Refer to official Microsoft documentation for deeper understanding

## Notes

- This repository is a study aid and should be used in conjunction with official Microsoft training materials
- Some content may require Azure subscription for practical labs
- Keep materials up-to-date as Azure services evolve
